...
public class HttpTest {
    ...
    public static void main(String[] args) {
        ...
        ClientHttpRequest request = template.getRequestFactory()
                .createRequest(new URI("https://m.che300.com/estimate/result/3/3/2931/52541/1830830/2022-1/13/1/null/2023/2022?rt=1"),
                        HttpMethod.GET);
        ...
        request.getHeaders().add("referer", "https://m.che300.com/estimate/result/3/3/2931/52541/1830830/2022-1/13/1/null/2023/2022?rt=1");
        request.getHeaders().add("sec-ch-ua", "\"Chromium\";v=\"106\", \"Google Chrome\";v=\"106\", \"Not;A=Brand\";v=\"99\"");
