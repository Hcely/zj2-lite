...
public class ZRBuilder implements Serializable {
    ...
    public static ZError failureErr(String msgFormat, Object arg0, Object arg1) {
        return ZError.cloneInstance().setSuccess(false).setStatus(ZStatusMsg.FAILURE_STATUS).setMsg(msgFormat, arg0, arg1);
    }

    public static ZError failureErr(String msgFormat, Object arg0, Object arg1, Object arg2) {
        return ZError.cloneInstance().setSuccess(false).setStatus(ZStatusMsg.FAILURE_STATUS).setMsg(msgFormat, arg0, arg1, arg2);
    }

    public static ZError failureErr(String msgFormat, Object arg0, Object arg1, Object arg2, Object arg3) {
        return ZError.cloneInstance().setSuccess(false).setStatus(ZStatusMsg.FAILURE_STATUS).setMsg(msgFormat, arg0, arg1, arg2, arg3);
    }

    public static ZError failureErr(String msgFormat, Object arg0, Object arg1, Object arg2, Object arg3, Object arg4) {
        return ZError.cloneInstance().setSuccess(false).setStatus(ZStatusMsg.FAILURE_STATUS).setMsg(msgFormat, arg0, arg1, arg2, arg3, arg4);
    }
    ...
    public <T> ZListResp<T> buildListResp(List<T> list, int totalCount, int pageNumber, int pageSize) {
        return new ZListResp<T>().setSuccess(getSuccess()).setStatus(status).setMsg(getMsg()).setData(list).setTotalCount(totalCount)
