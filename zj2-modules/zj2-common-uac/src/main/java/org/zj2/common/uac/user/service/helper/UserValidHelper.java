 ...
 */
@Component
public class UserValidHelper implements BizVHandler<UserOperationReq> {
    @Autowired
    ...
    private void updateExpire(UserOperationReq req) {
        ...
        update.setValidExpireTime(req.getExpireTime() == null ? NoneConstants.NONE_DATE : req.getExpireTime());
    ...
    private void addLog(UserDTO user, UserOperationReq req) {
        ...
        log.setLogEvent(UserEventEnum.SET_VALID.getCode());
